...
BEGIN
  IF NEW.is_default = TRUE THEN
    UPDATE user_address SET is_default = FALSE WHERE user_id = NEW.user_id AND is_default = TRUE;
  END IF;
END$$
DELIMITER ;
...
('influencer', 'Influencer/KOL with affiliate marketing capabilities');CREATE DATABASE IF NOT EXISTS ecommerce_db;
USE ecommerce_db;
